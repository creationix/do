...
// Turns any async function where the callback is the argument into a
// continuable. This is useful especially since all async functions on node
// are now callback based.  If you only need the fs module, then you can use the
// pre-wrapped fs module included in 'do/fs' as a drop-in replacement with
// continuable style instead.
exports.cont = function (fn) {
